...
\end{minted}
	...
	\begin{aligned}
		...
		\equiv
		\begin{cases}
			(for \ b \ i) \cdot \underline{0} = \underline{i} \\
			(for \ b \ i) \cdot succ = b \cdot for \ b \ i
		\end{cases}
	\end{aligned}
	\]
	...
	\[
	\begin{aligned}
		for \ b \ i &= \llparenthesis \, [\underline{i}, b] \, \rrparenthesis \\
		(a+) &= \llparenthesis \, [\underline{a}, succ] \, \rrparenthesis
	\end{aligned}
	\]
